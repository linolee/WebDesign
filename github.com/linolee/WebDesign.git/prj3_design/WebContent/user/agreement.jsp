...
<div class="areaFix">
	<div id="agreementDiv">
		<ul id="agreementList">
			<li>약관1 <textarea rows="20" readonly="readonly">
				본 약관(이하 ‘본 약관’이라 함)은 LINE주식회사(이하 ‘당사’라 함)가 제공하는 네이버 라인에 관한 모든 제품 및 서비스(이하 ‘본 서비스’라 함)의 이용에 관한 조건에 대해 본 서비스를 이용하는 고객(이하 ‘고객’이라 함)과 당사간에 정하는 것입니다.
...
최종갱신일：2013년 04월 01일
	...
	<li>약관2
		...
		</div> <input type="checkbox">약관에 동의합니다.
	</li>
